            ...
            <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 overflow-x-auto">
                <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
                    ...
                    <div class="flex items-center gap-px rounded-lg bg-gray-100 p-1">
                        ...
                        <button wire:click="$set('view', 'day')"
                        ...
                        <button wire:click="$set('view', 'week')"
                        ...
                        <button wire:click="$set('view', 'month')"
                ...
                <div class="relative">
                    @if ($view === 'month')
                        <div class="grid grid-cols-7 border-t border-gray-200 sticky top-0 left-0 w-full">
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Mon
                            </div>
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Tue
                            </div>
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Wed
                            </div>
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-600">Thur
                            </div>
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Fri
                            </div>
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Sat
                            </div>
                            <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">Sun
                            </div>
                        </div>
                        @foreach (array_chunk($dates->toArray(), 7) as $week)
                                    ...
                                    <div
                                        ...
                                        @if (isset($groupedTasks[$date->toDateString()]))
                                            @foreach ($groupedTasks[$date->toDateString()] as $task)
                                                <div
                                                    class="rounded p-1.5 border-l-2 border-indigo-600 bg-indigo-50 mb-2">
                                    ...
                                    @if (isset($groupedTasks[$date->toDateString()]))
                                        @foreach ($groupedTasks[$date->toDateString()] as $task)
                                            <div class="rounded p-1.5 border-l-2 border-indigo-600 bg-indigo-50 mb-2">
                                                <p class="text-xs font-normal text-gray-900 mb-px">{{ $task->title }}
                                                </p>
                                                @if ($task->start_time && $task->end_time)
                                                    <p class="text-xs font-semibold text-indigo-600">
                                                        {{ $task->start_time }} -
