...
@section('content')
    <div class="divide-y divide-gray-200">
        <form autocomplete="off" class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7"
            method="POST" action="/create_account">
            @csrf
            <div class="relative">
            ...
            <div class="relative">
                <a href="{{ route('login') }}" class="underline capitalize">I have an account</a>
            </div>
            <div class="relative">
